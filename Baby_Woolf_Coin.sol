...
contract Baby_Woolf_Coin is BEP20, Ownable {
    ...
    uint256 public distributeRewardAtAmount = 42e30;
    ...
    function setFees(uint256 BNBRewards, uint256 liquidity, uint256 metaverse, uint256 vault, uint256 app, uint256 bur, uint256 largeTokenSell) public onlyOwner {
        ...
        appFee = app;
        burnFee = bur;
        largeTokenSellFee = largeTokenSell;
    }
    ...
    function setdistributeRewardAtAmount(uint256 amount) public onlyOwner {
        distributeRewardAtAmount = amount;
    }
    ...
    function _transfer(
        ...
        bool canSwap = contractTokenBalance >= distributeRewardAtAmount;
...
contract Baby_Woolf_Dividend_Tracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("Baby_Woolf_Dividend_Tracker", "BWDT") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 1e29; //must hold 100000000000+ tokens
    }
